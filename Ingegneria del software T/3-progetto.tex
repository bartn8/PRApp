...
\begin{center}
    \begin{tabularx}{1\textwidth}{|l|X|X|}
         ...
         \hline
         \multirow{2}{*}{\shortstack[l]{Informazioni su\\ amministratori di sistema}} & Medio-Alto &  Alta \\
...
%TODO: Chiedere la molteplicità se va bene
%TODO: Chiedere se le molteplicità cambiano nella progettazione
...
\begin{figure}[H]
    \includegraphics[scale=0.50]{Analisi/Diagrammi_Classi/diagramma_classi_gestione_utente.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.5]{Analisi/Diagrammi_Classi/diagramma_classi_gestione_staff.png}
    \centering
...
%TODO: chiedere come funziona il blocco attivazione: se gli attori possono essere usati col blocco, vedi diagramma vendita prevendita o registrazione utente

%TODO: Chiedere se sono sufficienti
...
\begin{figure}[H]
    \includegraphics[scale=0.7]{Analisi/Diagrammi_Sequenza/diagramma_sequenza_creazione_evento.png}
    \centering
...
%R21F - Un evento puo essere annullato, anche se ci sono prevendite vendute.
%R23F - Una prevendita puo essere annullata e/o rimborsata.

%R8NF - Il periodo di vendita delle prevendite deve essere antecedente il periodo dell’evento.
%R9NF - Una prevendita annullata e/o rimborsata rimane tale
%R10NF - Un evento annullato rimane tale
%R13NF - Ogni prevendita venduta `e associata ad una sola tipologia di prevendita
%R14NF - La tipologia di prevendita associata non `e modificabile
%R15NF - Il prezzo di una tipologia di prevendita `e modificabile solo se non sono state vendute prevendite conquella determinata tipologia
%R19NF - La timbratura puo essere fatta solo una volta

%TODO: riguardare con il prof
...
%TODO: Da chiedere se il diagramma a package va bene
%TODO: Da chiedere se bisogna tenere uno o l'altro
%TODO: Da chiedere se il pattern broker è utilizzato correttamente
%TODO: Da chiedere dove mettere il protocollo di comunicazione tra middle-ware e front-end
...
%TODO: chiedere la divisione di package in base al livello middle-ware o front-end.
%TODO: chiedere come definire lo scambio dei dati tra middle-ware e front-end
%TODO: Chiedere se vanno descritte tutte
...
%Package it.unibo.prevenditaelettronica.middleware.model.dao.broker

%DatabaseBrokerInterface

%Interfaccia per gestire la connessione per ogni dbms
%Eccezioni 

%Package it.unibo.prevenditaelettronica.middleware.dao.proxy

%Dominio che richiede proxy

%Package it.unibo.prevenditaelettronica.middleware.model.log

%FileSystemInterface
%FileSystemImplementation

%Package it.unibo.prevenditaelettronica.middleware.model
...
%Package it.unibo.prevenditaelettronica.middleware.gestioneutente.controller

%Gestione Utente Controller
%Gestione Log Controller

%Package it.unibo.prevenditaelettronica.middleware.gestionestaff.controller
...
%Package it.unibo.prevenditaelettronica.middleware.log.controller

%Log

%Package it.unibo.prevenditaelettronica.middleware.autenticazione.controller

%AutenticazioneController


%Package it.unibo.prevenditaelettronica.middleware.handler
...
%Package it.unibo.prevenditaelettronica.frontend.common.model.net

%HTTPHandler
%JSONParser

%Package it.unibo.prevenditaelettronica.frontend.common.model.broker

%BrokerInterface
%Broker

%Package it.unibo.prevenditaelettronica.frontend.common.controller

%Gestione Staff Controller
%Gestione Utente Controller - alcune funzionalità sono solo di amministratore di sistema
%Autenticazione Controller

%Package it.unibo.prevenditaelettronica.frontend.utente.controller
%Package it.unibo.prevenditaelettronica.frontend.amministratoredisistema.controller

%Gestione Log Controller

%Package it.unibo.prevenditaelettronica.frontend.membro.controller

%Package it.unibo.prevenditaelettronica.frontend.pr.controller

%Gestione Vendita Prevendite Controller

%Package it.unibo.prevenditaelettronica.frontend.cassiere.controller

%Gestione Entrata Controller

%Package it.unibo.prevenditaelettronica.frontend.amministratore.controller
...
%Package it.unibo.prevenditaelettronica.frontend.common.view

%Interfaccia Autorizzazione
%Interfaccie Gestione Utente
%Interfaccie Gestione Staff

%Package it.unibo.prevenditaelettronica.frontend.utente.view

%Interfaccia Accedi staff
%Interfaccia Crea staff
%Interfaccia Cambia password

%Package it.unibo.prevenditaelettronica.frontend.amministratoredisistema.view

%Interfacce Gestione Log
%Interfacce Sblocco utente
%Interfacce Registra utente

%Package it.unibo.prevenditaelettronica.frontend.membro.view

%Interaccia Visualizza statistiche personali

%Package it.unibo.prevenditaelettronica.frontend.pr.view

%Interfaccie Gestione vendita prevendita

%Package it.unibo.prevenditaelettronica.frontend.cassiere.view

%Interfaccie Gestione entrata

%Package it.unibo.prevenditaelettronica.frontend.amministratore.view
