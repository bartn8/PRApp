...
\begin{figure}[H]
    \includegraphics[scale=0.65]{Progettazione/Package/model/dao/dao_database.png}
    \centering
    \caption{dao.vsdx}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=0.9]{Progettazione/Package/model/dao/dao_log.png}
    \centering
    \caption{dao.vsdx}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=1]{Progettazione/Package/model/dao/dao_exception.png}
    \centering
    \caption{dao.vsdx}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=0.8]{Progettazione/Package/model/dao/proxy/proxy.png}
    \centering
    \caption{proxy.vsdx}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=0.65]{Progettazione/Package/model/model.png}
    \centering
    \caption{model.vsdx}
\end{figure}
...
\paragraph{Package} it.unibo.prevenditaelettronica.middleware.gestioneutente.controller

%Gestione Utente Controller
%Gestione Log Controller

\paragraph{Package} it.unibo.prevenditaelettronica.middleware.gestionestaff.controller
...
\paragraph{Package} it.unibo.prevenditaelettronica.middleware.log.controller

%Log

\paragraph{Package} it.unibo.prevenditaelettronica.middleware.autenticazione.controller
