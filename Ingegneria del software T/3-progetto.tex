...
\begin{itemize}
    ...
    \item \hypertarget{R26F}{R26F} - Creare un sistema di log per il tracciamento delle operazioni.
    ...
    \item \hypertarget{R27NF}{R26NF} - Il sistema deve essere in grado di riconoscere prevendite contraffatte.
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|}
        ...
        Gestione utente & Gestione dei dati, interazione con l'esterno & Complesso & \\
        \hline
        Gestione dei log & Gestione dei dati, memorizzazione di dati, interazione con l'esterno & Complesso & \hyperlink{R26F}{R26F}, \hyperlink{R27F}{R27F}\\
        \hline
        ...
        Gestione staff & Gestione dei dati, interazione con l'esterno & Complesso &  \\
        \hline
        ...
        \hline
        Autenticazione & Gestione di dati, interazione con l'esterno & Semplice & \hyperlink{R2F}{R2F}, \hyperlink{R3F}{R3F} \\
        \hline
    \end{tabularx}
\end{center}
...
\subsubsection{Gestione Utente - Tabella Informazioni/Flusso}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|X|}
        ...
        \hline
        \hline
        Tipologia utente & Semplice & Medio & Input & \\
        \hline
    \end{tabularx}
\end{center}

\subsubsection{Gestione dei log  - Tabella Informazioni/Flusso}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|X|}
        ...
        \hline
        \hline
        Record log & Semplice & Medio & Input & \\
        \hline
    \end{tabularx}
\end{center}
