...
\begin{tabularx}{1\textwidth}{|l|X|}
	...
	\textbf{Scenario principale} & 1. Il Cassiere è già autenticato.\\
								 ...
								 & 3. Il sistema fornisce una vista.\\
								 & 4. Il Cassiere inserisce i dati relativi al documento digitale fornito dal cliente.\\
								 & 5. Il Cassiere esegue l'operazione.\\
								 & 6. Il Cassiere informa il cliente riguardo l'esito dell'entrata.\\
...
\begin{itemize}
    ...
    %Devo contare i tentativi falliti nel db: nella sessione potrei cancellare i cookie.
    \item \hypertarget{R20NF}{R20NF} - Il blocco dell'account deve avvenire dopo 3 tentativi.
    %HTTPS
...
\begin{tabularx}{1\textwidth}{|l|X|}
	...
	\textbf{Scenari alternativi} & A) L'utente sbaglia credenziali: \\
								 ...
								 & \quad 1. Mostro la schermata principale.\\
	\hline
	\textbf{Requisiti non funzionali} & \hyperlink{R1NF}{R1NF}, \hyperlink{R6NF}{R6NF}, \hyperlink{R15NF}{R15NF}, \hyperlink{R20NF}{R20NF} \\
	\hline
	\textbf{Punti aperti} & \\
	\hline
\end{tabularx}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|}
        ...
        \hline
        Lettura log & lettura dei dati, interazione con l'esterno & Semplice & \hyperlink{R26F}{R26F}, \hyperlink{R27F}{R27F}\\
        \hline
        Scrittura log & memorizzazione di dati, interazione con l'esterno & Semplice & \hyperlink{R26F}{R26F}\\
        \hline
...
\textbf{Lettura log  - Tabella Informazioni/Flusso}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|X|}
        ...
        \hline
        \hline
        Timestamp record & Semplice & Medio & Output & \\
        \hline
        Descrizione record & Semplice & Medio & Output & Non più di 256 caratteri \\
        \hline
        Livello di importanza record & Semplice & Medio & Output & Enumeratore: Basso, Medio, Alto\\
        \hline
    \end{tabularx}
\end{center}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|X|}
        ...
        \hline
        \hline
        Nome & Semplice & Alto & Input & Non più di 100 caratteri\\
        \hline
        Codice di accesso & Semplice & Alto & Input & \hyperlink{R2NF}{R2NF}, Non più di 50 caratteri\\
        \hline
    \end{tabularx}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|X|}
        ...
        \hline
        \hline
        Informazioni membro & Complesso & Input & \hyperlink{R7F}{R7F}\\
        \hline
    \end{tabularx}
\end{center}
...
\begin{center}
    \begin{tabularx}{1\textwidth}{|X|X|X|X|X|}
        ...
        \hline
        \hline
        Tipologia prevendita & Complesso & Input & \hyperlink{R22F}{R22F} \\
        \hline
    \end{tabularx}
\end{center}
