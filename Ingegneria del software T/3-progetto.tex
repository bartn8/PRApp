...
\begin{figure}[H]
    \includegraphics[scale=1]{Cases/use_cases.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.75]{Cases/security_use_cases_misuse_cases.png}
    \centering
...
\subsubsection{Glossario aggiornato}
  ...
  \begin{center}
    \begin{tabulary}{1\textwidth}{|c|C|C|}
		...
		\hline
		Verifica Contraffazione & Sistema volto a verificare l'autenticità di un
    \end{tabulary}
  \end{center}
...
\begin{figure}[H]
    \includegraphics[scale=1]{Cases/use_cases_aggiornato.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.8]{Diagrammi_Package/diagramma_package.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.75]{Diagrammi_Sequenza/diagramma_sequenza_autenticazione.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.65]{Diagrammi_Sequenza/diagramma_sequenza_registrazione_utente.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.7]{Diagrammi_Sequenza/diagramma_sequenza_creazione_evento.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.6]{Diagrammi_Sequenza/diagramma_sequenza_vendita_prevendita.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=0.55]{Diagrammi_Sequenza/diagramma_sequenza_ingresso_evento.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=1]{Diagrammi_Stato/diagramma_stato_evento.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[scale=1]{Diagrammi_Stato/diagramma_stato_prevendita.png}
    \centering
...
\lstinputlisting[language=Java]{Test/TestEvento.java}
\lstinputlisting[language=Java]{Test/TestPrevendita.java}
