...
\paragraph{Entità} Le chiavi primarie (\textbf{id}) sono di tipo intero, autoincrement, questo per semplificare l'utilizzo del pattern DAO. Di seguito l'elenco delle entità più importanti:
