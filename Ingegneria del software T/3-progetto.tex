...
\begin{center}
    ...
    \hline
    \hline
    Utente & Può creare uno staff, e accedere ad altri staff. & View Autenticazione, Home Gestione utente, View Crea staff, View Accedi staff, View Cambia password & Alto grado di riservatezza & Il numero può essere gestito dall'amministratore di sistema, al più è limitato dalle risorse del sistema \\ 
    \hline
    Amministratore di sistema & Può fare tutte le operazioni di un utente e in più gestisce il log, lo sblocco di utenti bloccati e la registrazione di un nuovo utente & View Autenticazione, Home Gestione utente, View Crea staff, View Accedi staff, View Cambia password, Home gestione log, View Aggiungi log, View Leggi Log, View Sblocco utente, View Registrazione utente & Massimo grado di riservatezza & per ogni installazione software è sufficiente un amministratore di sistema\\
    \hline
...
\begin{center}
    ...
    \hline
    Amministratore di uno staff & Può effettuare tutte le operazioni di un membro e in più gestisce lo staff & Home gestione staff, View Visualizzazione statistiche personali, Home Gestione membri, View Modifica ruoli membro, View Rimuovi membro, View Cambia codice di accesso, View Visualizzazione statistiche, Home Gestione eventi, View Aggiungi evento, View Modifica evento, View Annulla evento, Home gestione tipologie prevendite, View Aggiungi tipologia prevendita, View modifica tipologia prevendita, View elimina tipologia prevendita & Alto grado di riservatezza & Numero massimo limitato dalle risorse del sistema\\
    \hline
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \hline
    Gestione membri & Modifica ruoli membro, Rimuovi membro\\
    \hline
    Gestione eventi & Aggiungi evento, Modifica evento, Annulla evento\\
    \hline
    Gestione tipologie prevendita & Aggiungi tipologia prevendita, Modifica tipologia prevendita, Rimuovi tipologia prevendita\\
    \hline
    \end{tabularx}
\end{center}

%TODO: tabelle sotto funzionalità
