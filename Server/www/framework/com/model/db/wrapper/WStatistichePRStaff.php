...
class WStatistichePRStaff implements DatabaseWrapper
{
     ...
     * @return WStatistichePRStaff wrapper convertito
     */
    public static function of($array)
    {
        ...
        return self::make((int) $array["idUtente"], (int) $array["idStaff"], (int) $array["prevenditeVendute"], (float) $array["ricavo"]);
    }
     ...
     * @return \com\model\db\wrapper\WStatistichePRStaff
     */
    public static function make($idUtente, $idStaff, $prevenditeVendute, $ricavo)
    {
        if (is_null($idUtente) || is_null($idStaff) || is_null($prevenditeVendute) || is_null($ricavo))
            throw new InvalidArgumentException("Uno o più parametri nulli");
        
        if (! is_int($idUtente) || ! is_int($idStaff) || ! is_int($prevenditeVendute) || ! is_float($ricavo))
        ...
        return new WStatistichePRStaff($idUtente, $idStaff, $prevenditeVendute, $ricavo);
    }
    ...
    protected function __construct($idUtente, $idStaff, $prevenditeVendute, $ricavo)
    {
