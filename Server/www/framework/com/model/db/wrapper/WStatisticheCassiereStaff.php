...
class WStatisticheCassiereStaff implements DatabaseWrapper
{
     ...
     * @return WStatisticheCassiereStaff wrapper convertito
     */
    public static function of($array)
    {
        ...
        return self::make((int) $array["idUtente"], (int) $array["idStaff"], (int) $array["entrate"]);
    }
     ...
     */
    public static function make($idUtente, $idStaff, $entrate)
    {
        if (is_null($idUtente) || is_null($idStaff) || is_null($entrate))
            throw new InvalidArgumentException("Uno o più parametri nulli");
        
        if (! is_int($idUtente) || ! is_int($idStaff) || ! is_int($entrate))
        ...
        return new WStatisticheCassiereStaff($idUtente, $idStaff, $entrate);
    }
    ...
    /**
     * Entrate effettuate dal cassiere nello staff.
     * (>=0).
     *
     * @var int
     */
    ...
    protected function __construct($idUtente, $idStaff, $entrate)
    {
