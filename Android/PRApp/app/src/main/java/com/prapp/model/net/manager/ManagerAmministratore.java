...
public class ManagerAmministratore extends Manager {
    ...
    public void modificaEvento(UpdateNetWEvento evento, final Response.Listener<WEvento> onSuccess, final Response.Listener<List<Eccezione>> onException)  {
    ...
    public void aggiungiTipoPrevendita(InsertNetWTipoPrevendita tipoPrevendita, final Response.Listener<WTipoPrevendita> onSuccess, final Response.Listener<List<Eccezione>> onException)  {
    ...
    public void modificaTipoPrevendita(UpdateNetWTipoPrevendita tipoPrevendita, final Response.Listener<WTipoPrevendita> onSuccess, final Response.Listener<List<Eccezione>> onException)  {
    ...
    public void eliminaTipoPrevendita(int idTipoPrevendita, final Response.Listener<WTipoPrevendita> onSuccess, final Response.Listener<List<Eccezione>> onException)  {
