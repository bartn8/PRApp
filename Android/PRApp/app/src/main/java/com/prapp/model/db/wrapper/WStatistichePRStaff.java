...
public class WStatistichePRStaff implements  DatabaseWrapper, Twinned, JSONSerializable, JSONDeserializable {

    public static final String CLASS_PATH = "com\\model\\db\\wrapper\\WStatistichePRStaff";

    public WStatistichePRStaff getEmpty()
    {
        return new WStatistichePRStaff(0,0,0,0.00f);
    }
    ...
    public WStatistichePRStaff(Integer idUtente, Integer idStaff, Integer prevenditeVendute, Float ricavo) {
